        ...
        // <SafeAreaView>
            <View style={{flex:1,backgroundColor:'#329998'}}>            
                {/* <View style={styles.top}>
                   <Pressable onPress={()=>{navigation.navigate("UserDrawer")}}>
                        <Image  source={logo} style={{width:40 ,height:40,marginTop:13}} />
                   </Pressable>
                    <Text style={{color:"pink",marginTop:25}}><Text style={{fontWeight:'bold'}}>Vaccine App</Text></Text>
                </View> */}
                <ScrollView>
                    ...
                    <View style={{justifyContent:'center',alignItems:'flex-end',marginTop:30,marginRight:30}}>
                        ...
                        <Text style={{fontWeight:'bold',color:'white'}}>Welcome User! </Text>
                    </View>
