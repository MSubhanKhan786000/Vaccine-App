...
const PersonalModelProfile = ({navigation,modalVisible,setModalVisible}) => {
                ...
                setModalVisible(!modalVisible);
                    ...
                    <View style={styles.modalView}>
                        ...
                        <Pressable onPress={ 
                            (e)=>{
                                axios
                                .post("http://192.168.1.103:4000/OnlyUserRoutes/profile", {name,gender,age,cnic,country,phoneno,medical,allergies})
                                .then((res) => {
